...
class Philosophy extends StatefulWidget {
  const Philosophy({super.key});

  @override
  State<Philosophy> createState() => _NonFictionState();
}

class _NonFictionState extends State<Philosophy> {
  ...
  void initState() {
    ...
    nonFictionBooks =
        dummyBooks.where((book) => book.categorie == 'Philosophy').toList();
  }
