...
class Classicfiction extends StatefulWidget {
  const Classicfiction({super.key});

  @override
  State<Classicfiction> createState() => _NonFictionState();
}

class _NonFictionState extends State<Classicfiction> {
  ...
  void initState() {
    ...
    nonFictionBooks = dummyBooks
        .where((book) => book.categorie == 'Classic Fiction')
        .toList();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Classic Fiction"),
      ...
      body: nonFictionBooks.isEmpty
          ? const Center(
              child: Text(
                "No Classic Fiction books available",
